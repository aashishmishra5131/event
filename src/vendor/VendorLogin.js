  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-500 to-green-500">
      <div className="bg-white p-8 rounded shadow-md w-96">
        <h2 className="text-3xl font-bold mb-6 text-center text-gray-800">Vendor Login</h2>
        <div className="mb-4">
        ...
        <div><p className="text-center">Do not have account ? <Link to={'/VendorSignUp'}>SignUp</Link></p></div>
      </div>
    </div>
  );
};
